...
export class Table extends React.Component {
    ...
    handleChange(obj, jump, sorter={}) {
        ...
        if(this.requestParams){
            ...
            delete this.requestParams.pageIndex;
        ...
        this.fetch({
            ...
            pageNum : obj.current,
            pageIndex:obj.current,
        }, Object.assign({},this.props.params,this.requestParams));
    }

    fetch(obj={pageSize: this.state.pageSize, pageNum: this.state.pageNum,pageIndex:this.state.pageIndex}, params = {}) {
    ...
    render() {
        let {columns, scroll,rowKey, className, rowSelection, pageSizeOptions,showPage=true,extra,showTotal=true} =this.props;
