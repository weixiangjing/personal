...
export class SearchItemWithRadio extends React.Component {
    ...
    render() {
        let {title, name, items, length,initialValue} =this.props;
           ...
           
            {
                getFieldDecorator(name,{
                    initialValue
                         ...
                         <RadioGroup  size="small" style={{paddingLeft:24}} className="search-radio-item ant-none-border ant-active-color">
...
export class SearchItemWithInput extends React.Component {
    ...
    render() {
        ...
        return (
            <FormItem>
                <label className="search-label">{title}</label>
                <span style={{width:300,paddingLeft:24}}  className="search-radio-item">
                      {
                          getFieldDecorator(name, {})(
