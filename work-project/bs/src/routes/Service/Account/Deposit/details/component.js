...
export default React.createClass({
  componentWillMount(){
    getList({account_no:user.account_no,charge_order_no:this.props.location.query.order_no});
  },
  render(props,state){
                ...
                <Col span={12}>
                  <div className="data-item">
                    <ul>
                      ...
                      <li><span>充值订单金额：</span>{objItem.charge_amount?toThousands("元",objItem.charge_amount):"0"}元</li>
                    </ul>
                  </div>
                </Col>
                <Col span={12}>
                  <div className="data-item">
                    <ul>
                      ...
                      <li><span>实付金额：</span>{objItem.order_real_amount?toThousands("元",objItem.order_real_amount):"0"}元</li>
                    </ul>
                  </div>
                </Col>
              </Row>
