...
class MenuComponent extends React.Component {
    ...
    render() {
        ...
        return <Sider className="slide-bar">
            <Menu onClick={(e)=>this.onTitleClick(e)} mode="inline" defaultOpenKeys={this.state.openKeys}
                ...
                {menu.map((menu)=> {
                    ...
                    if(children) {
                        ...
                        return <Menu.Item className="final"
                                          key={"/"+menu.route}><Icon type={menu.icon}/><i className={`fa fa-${menu.icon_url}`}/>{menu.name}</Menu.Item>
                    }
                })}
            </Menu>
        </Sider>
