...
export function echoPackage (query,form){
    getPackage(query).then(res=>{
        let obj =res.data[0];
        obj.combo_discount_price=decimal( obj.combo_discount_price).div(100).valueOf();
...
export function postPackage(form){
    form.validateFields((error,value)=>{
        ...
        value.combo_discount_price=decimal(100).mul(value.combo_discount_price).valueOf()
