...
import {Form,Input,Row,Col,Upload,Button,Popconfirm} from "antd";
...
import {handler,stop} from "../Info/reducer";
                    ...
                    <Col  offset={3}>
                        ...
                        <Auth to={AuthConf.SERVICE_INFO_DELETE}>
                            <Popconfirm title="确认删除该服务"
                                        onConfirm={()=>stop({
                                            service_code: this.props.alterId, is_delete: 2
                                        }).then(()=>{
                                            handler._reload=true;
                                            hashHistory.goBack();
            
                                        })}
                            >
                                <Button className="margin-left" type={"danger"}>删除</Button>
                            </Popconfirm>
                        </Auth>
                    </Col>
